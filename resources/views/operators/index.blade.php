                    ...
                    <nav aria-label="...">
                        <ul class="pagination justify-content-center">
                            <li class="page-item @if ($operadores['current_page'] === 1) disabled @endif">
                                <a class="page-link" href="?page={{ $operadores['current_page'] - 1 }}" tabindex="-1" aria-disabled="true">Previous</a>
                            </li>
                            ...
                            @endfor
                            <li class="page-item">
                                <a class="page-link" href="?page={{ $operadores['current_page']  + 1 }}">Next</a>
                            </li>
                        </ul>
                    </nav>
                </div>
